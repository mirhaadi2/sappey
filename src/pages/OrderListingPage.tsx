      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-12">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="flex items-center gap-3">
            ...
            <button onClick={() => navigate("/shop")} className="flex items-center gap-2 px-5 py-2.5 text-sm font-bold text-white bg-slate-950 rounded-xl hover:bg-slate-800 transition-all shadow-lg shadow-slate-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {[
            ...
            { label: "Total Expenditure", value: `$${stats.totalSpent.toLocaleString()}`, icon: CurrencyDollar, color: "text-emerald-600", bg: "bg-emerald-50" },
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="bg-slate-50/80 border-b border-slate-100">
                  ...
                  <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.15em] text-slate-400">Fulfillment</th>
                  <th className="px-8 py-5 text-[10px] font-black uppercase tracking-[0.15em] text-slate-400 text-right">Value (USD)</th>
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-8 py-6 text-right">
                          <p className="text-base font-black text-slate-950">${parseFloat(order.finalAmount).toLocaleString(undefined, { minimumFractionDigits: 2 })}</p>
