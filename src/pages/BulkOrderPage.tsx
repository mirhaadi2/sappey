...
import { ArrowRight, CheckCircle, Building, Suitcase, Phone, EnvelopeSimple, Sparkle } from "@phosphor-icons/react";
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
                    <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] items-center">
                        ...
                        <div className="rounded-[32px] border border-white/15 bg-white text-slate-900 shadow-[0_30px_80px_rgba(0,0,0,0.12)] p-8 md:p-10">
                            ...
                            <form className="space-y-4" id="bulk-order-form">
                                <div className="grid gap-4 sm:grid-cols-2">
                                ...
                                <label className="block">
                                    <span className="text-sm font-semibold text-slate-700">Product / Category</span>
                                    <input
                                        type="text"
                                ...
                                <label className="block">
                                    <span className="text-sm font-semibold text-slate-700">Estimated Quantity</span>
                                    <input
                                        type="text"
                                        placeholder="e.g. 500 kg, 100 cartons"
                                        className="mt-2 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-brand-cocoa focus:ring-2 focus:ring-brand-cocoa/15"
                                    />
                                </label>
                                <label className="block">
                                    ...
                                    <textarea
                                        placeholder="Packaging, delivery window, custom requests"
                                        rows={4}
                                        className="mt-2 w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-brand-cocoa focus:ring-2 focus:ring-brand-cocoa/15"
                                    />
                                </label>
                                ...
                                <button
                                    type="submit"
                                    className="mt-3 inline-flex items-center justify-center gap-3 w-full rounded-2xl bg-brand-brown px-6 py-4 text-sm font-bold uppercase tracking-[0.18em] text-brand-cream shadow-[0_20px_40px_rgba(34,22,9,0.25)] transition hover:bg-brand-cocoa"
                                >
                                    Submit Request
